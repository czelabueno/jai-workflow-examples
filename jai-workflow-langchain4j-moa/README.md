# jAI Workflow :: Mixture of Agents (MoA)

## Overview
`jai-workflow-langchain4j-moa` is a Java implementation of the Mixture of Agents (MOA) concept, as described in the relevant [AI research paper](https://arxiv.org/pdf/2406.04692). It leverages the `jai-workflow` and `langchain4j` libraries to provide a robust and efficient solution. 
...
## How to use
To use `jai-workflow-langchain4j-moa`, you need to instance the `MixtureOfAgents` interface. You can use `DefaultMixtureOfAgents` class to get quickly a completeness implementation.
### Installation
```shell
mvn clean package install
```
> **Please note**: that `jai-workflow-langchain4j-moa` depends on `jai-workflow-0.1.0.jar`. Before installing `jai-workflow-langchain4j-moa`, ensure that `jai-workflow-0.1.0.jar` is installed in your local repo by following the instructions provided in the [jai-workflow repository](https://github.com/czelabueno/jai-workflow?tab=readme-ov-file#installation).
> 
>The process of distributing `jai-workflow-langchain4j-moa` on Maven Central is currently underway.
...
<dependencies>
   ...
   <dependency>
      ...
      <artifactId>jai-workflow-langchain4j-moa</artifactId>
...
## Example
Here is a simple example of how to use the `jai-workflow-langchain4j-moa` module::
...
Console
```shell
2024-07-10 23:01:59 [main] internal.io.github.czelabueno.jai.workflow.moa.DefaultMixtureOfAgents.moaWorkflow()
INFO: === Generating MOA architecture.. ===
2024-07-10 23:01:59 [main] internal.io.github.czelabueno.jai.workflow.moa.DefaultMixtureOfAgents.lambda$moaWorkflow$2()
...
2024-07-10 23:01:59 [main] workflow.io.github.czelabueno.jai.workflow.moa.MoaNodeFunctions.proposerAgent()
INFO: ---PROPOSER AGENT: Layer (1), AgentModel: openMixtral822B---
2024-07-10 23:01:59 [main] dev.langchain4j.workflow.DefaultStateWorkflow.runNode()
DEBUG: Running node name: AgentNode 1.2: claude3Haiku..
2024-07-10 23:02:10 [main] workflow.io.github.czelabueno.jai.workflow.moa.MoaNodeFunctions.proposerAgent()
...
2024-07-10 23:02:15 [main] workflow.io.github.czelabueno.jai.workflow.moa.MoaNodeFunctions.proposerAgent()
...
2024-07-10 23:02:20 [main] workflow.io.github.czelabueno.jai.workflow.moa.MoaNodeFunctions.proposerAgent()
...
2024-07-10 23:02:28 [main] workflow.io.github.czelabueno.jai.workflow.moa.MoaNodeFunctions.proposerAgent()
...
2024-07-10 23:02:34 [main] workflow.io.github.czelabueno.jai.workflow.moa.MoaNodeFunctions.proposerAgent()
...
2024-07-10 23:02:41 [main] workflow.io.github.czelabueno.jai.workflow.moa.MoaNodeFunctions.proposerAgent()
...
2024-07-10 23:02:46 [main] workflow.io.github.czelabueno.jai.workflow.moa.MoaNodeFunctions.proposerAgent()
...
2024-07-10 23:02:55 [main] workflow.io.github.czelabueno.jai.workflow.moa.MoaNodeFunctions.aggregatorAgent()
INFO: ---AGGREGATE MODEL: io.github.czelabueno.jai.workflow.moa.AggregatorChatLanguageModel---
2024-07-10 23:03:02 [main] dev.langchain4j.workflow.DefaultStateWorkflow.runNode()
DEBUG: Reached END state
2024-07-10 23:03:02 [main] internal.io.github.czelabueno.jai.workflow.moa.DefaultMixtureOfAgents.processQuestion()
DEBUG: Transitions:
...
DEBUG: Workflow image saved to: /Users/CarlosZela1/jai-workflow-examples/jai-workflow-langchain4j-moa/images/moa-wf-4.svg
...
Console
```shell
2024-07-07 19:31:26 [main] internal.io.github.czelabueno.jai.workflow.moa.DefaultMixtureOfAgents.moaWorkflow()
INFO: === Generating MOA architecture.. ===
2024-07-07 19:31:26 [main] internal.io.github.czelabueno.jai.workflow.moa.DefaultMixtureOfAgents.lambda$moaWorkflow$2()
...
2024-07-07 19:31:26 [main] internal.io.github.czelabueno.jai.workflow.moa.DefaultMixtureOfAgents.moaWorkflow()
INFO: Parsing MOA architecture to workflow...
2024-07-07 19:31:26 [main] internal.io.github.czelabueno.jai.workflow.moa.DefaultMixtureOfAgents.processQuestion()
...
2024-07-07 19:31:26 [main] workflow.io.github.czelabueno.jai.workflow.moa.MoaNodeFunctions.proposerAgent()
...
2024-07-07 19:31:32 [main] workflow.io.github.czelabueno.jai.workflow.moa.MoaNodeFunctions.proposerAgent()
...
2024-07-07 19:31:37 [main] workflow.io.github.czelabueno.jai.workflow.moa.MoaNodeFunctions.proposerAgent()
...
2024-07-07 19:31:43 [main] workflow.io.github.czelabueno.jai.workflow.moa.MoaNodeFunctions.proposerAgent()
...
2024-07-07 19:31:49 [main] workflow.io.github.czelabueno.jai.workflow.moa.MoaNodeFunctions.proposerAgent()
...
2024-07-07 19:31:55 [main] workflow.io.github.czelabueno.jai.workflow.moa.MoaNodeFunctions.proposerAgent()
...
2024-07-07 19:32:00 [main] workflow.io.github.czelabueno.jai.workflow.moa.MoaNodeFunctions.aggregatorStreamingAgent()
INFO: ---AGGREGATE STREAM MODEL: io.github.czelabueno.jai.workflow.moa.AggregatorStreamingChatLanguageModel---
2024-07-07 19:32:00 [main] workflow.io.github.czelabueno.jai.workflow.moa.MoaNodeFunctions.aggregatorStreamingAgent()
2024-07-07 19:32:00 [main] workflow.io.github.czelabueno.jai.workflow.moa.MoaNodeFunctions.aggregatorStreamingAgent()
...
DEBUG: Reached END state
2024-07-07 19:32:04 [main] internal.io.github.czelabueno.jai.workflow.moa.DefaultMixtureOfAgents.processQuestion()
DEBUG: Transitions: 
