...
import io.github.czelabueno.jai.workflow.moa.internal.DefaultMixtureOfAgents;
...
class MixtureOfAgentsIT {
    ...
    void run_using_generateStreamingModel() {
        ...
        String question = "Top things to do in NYC";
        List<String> expectedTokens = Arrays.asList("central", "park");

        // when
        Flux<String> tokens = moa.answerStream(question);
